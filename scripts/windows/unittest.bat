...
coverage run --omit=*/test/* --source D:\slave\workspace\ting_feature_Unit-Perf-TestTools\src  --branch -m pytest --cache-clear --junitxml build_pytest/pytest.xml D:\slave\workspace\ting_feature_Unit-Perf-TestTools\test
